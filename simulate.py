...
backLegX = numpy.linspace(backLegPhaseOffset, 2*backLegFrequency*numpy.pi+backLegPhaseOffset, 1000)
backLegTargetAngles = numpy.sin(backLegX)*backLegAmplitude
frontLegX = numpy.linspace(frontLegPhaseOffset, 2*frontLegFrequency*numpy.pi+frontLegPhaseOffset, 1000)
frontLegTargetAngles = numpy.sin(frontLegX)*frontLegAmplitude
